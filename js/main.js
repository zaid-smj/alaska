    ...
    const heroSlides = [
      {
        ...
        alt: "Automotive batteries in Pakistan",
        kicker: "Automotive Batteries",
        title: "Reliable Automotive Batteries in Pakistan",
        subtitle: "High-performance batteries engineered for dependable starting power, durability, and long-lasting performance.",
        primaryBtn: { text: "View Batteries", href: "dry-charge.html" },
        secondaryBtn: { text: "Get Support", href: "support.html" },
      },
      {
        desktop: "assets/slider-home/slide-2.webp",
        mobile: "assets/solutions/mobile/solar-mobile.webp",
        alt: "Solar batteries and backup power in Pakistan",
        kicker: "Solar & Backup Batteries",
        title: "Reliable Solar & Backup Batteries in Pakistan",
        subtitle: "Dependable energy storage solutions designed for solar systems, backup power, and everyday energy needs.",
        primaryBtn: { text: "Explore Batteries", href: "deep-cycle.html" },
        secondaryBtn: { text: "Find a Dealer", href: "dealers.html" },
      },
      {
        desktop: "assets/slider-home/slide-3.webp",
        mobile: "assets/solutions/mobile/industrial-mobile.webp",
        alt: "Alaska industrial batteries",
        kicker: "Industrial Batteries",
        title: "Industrial Batteries for Demanding Power Applications",
        subtitle: "Dependable battery solutions engineered for industrial, commercial, and backup power requirements.",
        primaryBtn: { text: "Explore Batteries", href: "dry-charge.html" },
        secondaryBtn: { text: "Get Support", href: "support.html" },
      },
    ];

  ...
  function initHomeHeroBannerSlider() {
    ...
    const heroSlides = [
      ...
      },
      {
        ...
        alt: "Industrial batteries in Pakistan",
        kicker: "Industrial Batteries",
        title: "Industrial Batteries Built for Reliable Power",
        subtitle: "Durable battery solutions engineered for industrial, commercial, and demanding backup power applications.",
        primaryBtn: { text: "View More", href: "#" },
        secondaryBtn: { text: "Get Support", href: "#" },
      },
    ];
